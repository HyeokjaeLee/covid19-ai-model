...
var normalization_data_set = normalization.by_standard_deviation();
var test_arr = normalization_data_set.slice(0, 17).map(function (data) { return data * normalization.standard_deviation + normalization.average; });
console.log(test_arr.slice(10, 17));
var output_arr = get_model_1.default(test, test_data_set.slice(0, 10));
var output_arr2 = output_arr.map(function (data) { return data * normalization.standard_deviation + normalization.average; });
